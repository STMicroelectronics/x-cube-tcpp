...
USBH_StatusTypeDef USBH_LL_Init(USBH_HandleTypeDef *phost)
{
  ...
  hhcd_USB_OTG_HS.Instance = USB_DRD_FS;
  hhcd_USB_OTG_HS.Init.Host_channels = 8U;
  hhcd_USB_OTG_HS.Init.speed = USB_DRD_SPEED_LSFS;
  hhcd_USB_OTG_HS.Init.dma_enable = DISABLE;
  hhcd_USB_OTG_HS.Init.phy_itface = HCD_PHY_EMBEDDED;
  hhcd_USB_OTG_HS.Init.Sof_enable = DISABLE;
  hhcd_USB_OTG_HS.Init.low_power_enable = DISABLE;
  hhcd_USB_OTG_HS.Init.vbus_sensing_enable = DISABLE;
  hhcd_USB_OTG_HS.Init.bulk_doublebuffer_enable = 0; /*if enabled all bulk channel will enable double-buffer mode*/
  hhcd_USB_OTG_HS.Init.iso_singlebuffer_enable  = 1 ;
