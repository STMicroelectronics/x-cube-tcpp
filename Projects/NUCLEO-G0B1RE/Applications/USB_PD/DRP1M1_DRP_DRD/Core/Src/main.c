...
static void MX_LPUART1_UART_Init(void)
{
  ...
  */
  ...
  NVIC_SetPriority(USART3_4_5_6_LPUART1_IRQn, 2);
...
static void MX_UCPD1_Init(void)
{
  ...
  */
  ...
  NVIC_SetPriority(USB_UCPD1_2_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),3, 0));
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(USER_BUTTON_EXTI_IRQn, 3, 0);
