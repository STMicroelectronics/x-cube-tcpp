...
Use of USB Power Delivery (USB-PD) SRC application on STM32G0XX devices, 
...
This application provides an example for managing the Port 0 as a Source port.
      ...
      options is provided in application directory in STMicroelectronics_SRC1M1_Source_STM32G071RB_VIF.xml file.
...
@par Directory contents
      ...
      |     └──── main.c                      Main program
      |     └──── stm32g0xx_hal_msp.c         HAL MSP Initialization file
      |     └──── stm32g0xx_it.c              Interrupt handlers
      |     └──── system_stm32g0xx.c          STM32G0xx system clock configuration file
      ...
      └──── Inc
            ...
            └──── stm32g0xx_hal_conf.h        HAL configuration file
            └──── stm32g0xx_it.h              Interrupt handlers header file
            ...
            └──── usbpd_os_port.h             Core OS portability macros header file
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics NUCLEO-G071RB board with X-NUCLEO-SRC1M1 shield.
